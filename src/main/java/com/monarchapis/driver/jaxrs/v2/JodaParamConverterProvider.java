...
/**
 * Provides support for serializing and deserializing Joda types.
 * 
 * @author Phil Kedy
 */
@Provider
public class JodaParamConverterProvider implements ParamConverterProvider {
	...
	/**
	 * The parameter converter for <code>DateTime</code>.
	 */
	...
	/**
	 * The parameter converter for <code>LocalDate</code>.
	 */
