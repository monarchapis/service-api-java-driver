...
/**
 * Provides a helper method for determining the best media type to response with
 * given the request's accept header.
 * 
 * @author Phil Kedy
 */
public abstract class MediaTypeUtils {
	...
	/**
	 * Returns the best media type for the current API request.
	 * 
